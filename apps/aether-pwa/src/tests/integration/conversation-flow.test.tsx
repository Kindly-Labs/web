...
jest.mock('@/scenes/Session/Orb/Orb', () => ({
  OrbContainer: ({ onInteraction }: { onInteraction: () => void }) => (
    <button data-testid="orb" onClick={onInteraction}>
      Orb
    </button>
  ),
}));
jest.mock('@/scenes/Session/components/Header', () => ({
  Header: () => <div data-testid="header" />,
}));
jest.mock('@/scenes/Session/components/Footer', () => ({
  Footer: () => <div data-testid="footer" />,
}));
jest.mock('@/scenes/Session/components/StatusDisplay', () => ({
  StatusDisplay: () => <div data-testid="status-display" />,
}));
jest.mock('@/scenes/Onboarding/WaitlistModal', () => ({
